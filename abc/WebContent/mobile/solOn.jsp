...
<body>
 <div data-role="page" id="page" style="margin: auto; vertical-align: middle;">
  ...
  <div>
   ...
   <div class="sil" >
				<a href="#"> <img class="img3" alt="플레시아"
					src="images/플레시아 그린티치약 3입기획.jpg"><br></a>
				<div>플레시아 그린티치약 3개</div>
				<div>25,000원</div>
			</div>
			<div class="sil">
				<a href="#"> <img class="img3" alt="플레시아"
					src="images/플레시아 베이직 무불소치약 3입기획.jpg"><br></a>
				<div>플레시아 베이직 무불소치약 3개</div>
				<div>26,000원</div>
			</div>
			<div class="sil">
				<a href="#"> <img class="img3" alt="플레시아"
					src="images/플레시아 솔잎티치약 3입기획.jpg"><br></a>
				<div>플레시아 솔잎티치약 3개</div>
				<div>14,500원</div>
			</div>
			<div class="sil">
				<a href="#"> <img class="img3" alt="플레시아"
					src="images/플레시아 피치민트치약 3입기획.jpg"><br></a>
				<div>플레시아 피치민트치약 3개</div>
				<div>13,500원</div>
			</div>
			<div class="sil">
				<a href="#"> <img class="img3" alt="메디안"
					src="images/메디안 미니언즈 키즈치약 75G 2입기획.jpg"><br></a>
				<div>메디안 미니언즈 키즈치약 75G 2개</div>
				<div>4,500원</div>
			</div>
			<div class="sil">
				<a href="#"> <img class="img3" alt="메디안"
					src="images/메디안 미백케어칫솔.jpg"><br></a>
				<div>메디안 미백케어칫솔</div>
				<div>3,500원</div>
			</div>
			<div class="sil">
				<a href="#"> <img class="img3" alt="메디안"
					src="images/메디안 잇몸케어칫솔.jpg"><br></a>
				<div>메디안 잇몸케어칫솔</div>
				<div>4,000원</div>
			</div>
			<div class="sil">
				<a href="#"> <img class="img3" alt="치석케어 "
					src="images/치석케어 칫솔 2입.jpg"><br></a>
				<div>치석케어 칫솔 2개</div>
				<div>8,500원</div>
			</div>
