...
<body>
 ...
 <div data-role="page" id="page" style="margin: auto; vertical-align: middle;">
  ...
  <li style="float: left; width: 25%; height: 15%;"><a href="#" data-role="button" class="log">장바구니</a></li>
  ...
  <div>
   ...
   <div data-role="panel" id="ch1" data-display="overlay" data-position-fixed="true"> 
    ...
    <a href="#" data-role="button" class="log">치약</a><br>
    <a href="#" data-role="button" class="log">바디워시</a><br>
    <a href="#" data-role="button" class="log">바디로션</a><br>
    <a href="#" data-role="button" class="log">선케어</a><br>
   
   </div>
   
   <div data-role="content" id="content">  
   <img style="width: 100%;" src="images/song.gif" class="img">
  </div>
   ...
   <div data-role="footer" style="width: 100%; margin: auto;">
    ...
    <div style="text-align: center;">
		...
		<div style="text-align: center;">
		<p><a href="#" data-role="button" class="log">교환 / 반품 정책 확인</a></p>
		</div>
